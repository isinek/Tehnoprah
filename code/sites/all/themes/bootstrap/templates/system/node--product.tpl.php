...
<div id="product">
	...
	<div class="image">
		<img src="<?php print ( isset($content['field_image']) ? $GLOBALS['base_path'].'sites/default/files'.substr(image_style_path('product_style', $content['field_image']['#items'][0]['uri']), 8) : '' ) ?>" alt="<?php print isset($content['field_image']) ? $content['field_image']['#items'][0]['alt'] : $title ?>" title="<?php print isset($content['field_image']) ? $content['field_image']['#items'][0]['title'] : $title ?>"/>
	</div>
	<div class="text">
		<?php print $content['body'][0]['#markup'] ?>
		<a class="simple-orange send-inquiry" <?php /*href="mailto:<?php print variable_get('site_mail', '').'?subject='.t('Upit za proizvod: ').$title ?> */ ?>"><?php print t('Send request about this product') ?></a>
	</div>
</div>
